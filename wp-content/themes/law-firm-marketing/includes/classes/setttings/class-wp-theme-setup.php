...
namespace LawFirmMarketing\Setup;
...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'lawfirmmarketing_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'lawfirmmarketing_td' ),
				'footer-nav-one'   => __( 'Footer Nav One', 'lawfirmmarketing_td' ),
				'footer-nav-two'   => __( 'Footer Nav Two', 'lawfirmmarketing_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'lawfirmmarketing_td' ),
				'legal-nav'        => __( 'Legal Nav', 'lawfirmmarketing_td' ),
			)
		);
