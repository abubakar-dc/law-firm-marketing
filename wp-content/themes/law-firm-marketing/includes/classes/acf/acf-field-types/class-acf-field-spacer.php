...
class Acf_Field_Spacer extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Spacer', 'lawfirmmarketing_td' );
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Default Value', 'lawfirmmarketing_td' ),
				'instructions' => __( 'Customize the input default Value', 'lawfirmmarketing_td' ),
				'type'         => 'text',
				'name'         => 'default_value',
				'append'       => '',
			)
