...
namespace LawFirmMarketing\Script;
...
define( 'LAWFIRMMARKETING_PROJECT_DTFORMAT', 'F j, Y' );
/**
 * Theme assets
 *
...
class WP_Theme_Scripts {
	...
	public function theme_assets() {
		...
		LawFirmMarketing::enqueue_style( 'assets/build/styles.min.css' );
		if ( wp_is_mobile() ) {
			LawFirmMarketing::enqueue_style( 'assets/build/mobile.min.css' );
		}
		...
		LawFirmMarketing::enqueue_script(
	...
	public function admin_assets() {
		...
		LawFirmMarketing::enqueue_style( 'assets/build/editor.min.css' );
	}
}
