...
$lmf_var_pagetitle          = $lmf_fields['lmf_var_pagetitle'] ?? get_the_title();
$lmf_var_trcho_feature_post = $lmf_fields['lmf_var_trcho_feature_post'] ?? null;
...
<section id="hero-section" class="hero-section hero-section-default">
	<div class="blog-hero">
		<div class="wrapper">
			...
			<?php
			if ( $lmf_var_trcho_feature_post ) {
				?>
				<?php
				foreach ( $lmf_var_trcho_feature_post as $lmf_var_post_id ) {
...
<section id="page-section" class="page-section">
	...
	<div class="wrapper">
		<?php
			// WP_Query.
			$lmf_query = LawFirmMarketing::query(
				array(
					'post_type'     => 'resource',
